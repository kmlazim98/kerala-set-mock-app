...
export default function AdminHome() {
  ...
  async function loadStudents() {
    ...
    try {
      ...
      const all  = snap.docs
        ...
        .map(u => ({ ...u, status: u.status ?? "pending" })) // default missing status
  ...
  return (
    <div style={{ fontFamily: "system-ui,-apple-system,sans-serif" }}>
      ...
      {/* ── Tabs ── */}
      <div style={{ display: "flex", borderBottom: "1.5px solid #eef2ee", marginBottom: "24px" }}>
        {tabs.map(({ key, label, badge }) => (
          <button
            ...
            style={{
              ...
              color:        tab === key ? "#1D9E75" : "#999",
              borderBottom: tab === key ? "2.5px solid #1D9E75" : "2.5px solid transparent",
              marginBottom: "-1.5px",
            }}
          >
            {label}
        ...
        <div>
          ...
          {loadingStudents ? (
            ...
            return (
              <div
                key={student.id}
                style={{ background: "white", border: "1.5px solid #eef2ee", borderRadius: "14px", marginBottom: "10px", overflow: "hidden" }}
              >
                {/* ── Student row ── */}
                <div style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "16px 18px", flexWrap: "wrap" }}>

                  {/* Avatar */}
                  <div style={{ width: "44px", height: "44px", borderRadius: "50%", background: sc.bg, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "17px", fontWeight: "800", color: sc.color, flexShrink: 0 }}>
                  ...
                  <div style={{ flex: 1, minWidth: "180px" }}>
                    ...
                    <div style={{ display: "flex", gap: "16px" }}>
                      <div>
                        <span style={{ fontSize: "15px", fontWeight: "800", color: "#111" }}>{studentAttempts.length}</span>
                        <span style={{ fontSize: "11px", color: "#aaa", marginLeft: "4px" }}>attempts</span>
                      </div>
                      <div>
                        <span style={{ fontSize: "15px", fontWeight: "800", color: bestScore != null ? (bestScore >= 55 ? "#1D9E75" : "#E24B4A") : "#ccc" }}>
                          {bestScore != null ? `${bestScore}%` : "—"}
                        </span>
                        <span style={{ fontSize: "11px", color: "#aaa", marginLeft: "4px" }}>best</span>
                      </div>
                      <div>
                        <span style={{ fontSize: "15px", fontWeight: "800", color: "#888" }}>
                          {avgScore != null ? `${avgScore}%` : "—"}
                        </span>
                        <span style={{ fontSize: "11px", color: "#aaa", marginLeft: "4px" }}>avg</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center", paddingTop: "2px" }}>
                    ...
                    {student.status === "pending" && (
                      <button
                        ...
                        style={{ padding: "9px 18px", borderRadius: "9px", border: "none", background: "#1D9E75", color: "white", cursor: "pointer", fontSize: "13px", fontWeight: "700" }}
                      >
                        ✓ Approve
                      </button>
                    )}
                    ...
                    {student.status === "active" && (
                      <button
                        ...
                        style={{ padding: "9px 16px", borderRadius: "9px", border: "1.5px solid #FAC775", background: "#FAEEDA", color: "#633806", cursor: "pointer", fontSize: "12px", fontWeight: "600" }}
                      >
                        Suspend
                      </button>
                    )}
                    ...
                    {student.status === "suspended" && (
                      <button
                        onClick={() => updateStudentStatus(student.id, "active")}
                        style={{ padding: "9px 16px", borderRadius: "9px", border: "1.5px solid #9FE1CB", background: "#E1F5EE", color: "#085041", cursor: "pointer", fontSize: "12px", fontWeight: "600" }}
                      >
                        Reactivate
                      </button>
                    )}
                    ...
                    <button
                      ...
                      style={{ padding: "9px 14px", borderRadius: "9px", border: "1.5px solid #eef2ee", background: "white", cursor: "pointer", fontSize: "12px", color: "#888", fontWeight: "600" }}
                    >
                    ...
                    <button
                      ...
                      style={{ padding: "9px 12px", borderRadius: "9px", border: "1.5px solid #F7C1C1", background: "#FCEBEB", color: "#A32D2D", cursor: "pointer", fontSize: "12px", fontWeight: "600" }}
                    >
                      ✕
                    </button>
                  </div>
                ...
                {isExpanded && (
                  <div style={{ borderTop: "1px solid #f0f0f0", padding: "16px 18px", background: "#fafcfa" }}>
                    <p style={{ fontSize: "11px", fontWeight: "700", color: "#aaa", letterSpacing: "0.07em", textTransform: "uppercase", margin: "0 0 12px" }}>
                    ...
                    {studentAttempts.length === 0 ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                        {studentAttempts.slice(0, 8).map(a => {
                          ...
                          const passed = pct >= 55;
                          return (
                            <div key={a.id} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "10px 14px", background: "white", borderRadius: "10px", border: "1px solid #eef2ee" }}>
                              <div style={{ width: "38px", height: "38px", borderRadius: "50%", background: passed ? "#E1F5EE" : "#FCEBEB", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                              ...
                              <div style={{ flex: 1 }}>
                                <div style={{ fontSize: "12px", fontWeight: "600", color: "#333" }}>
                                  ...
                                  {a.partNumber && (
                                    <span style={{ marginLeft: "6px", fontSize: "10px", background: "#E1F5EE", color: "#085041", padding: "1px 6px", borderRadius: "999px" }}>
                                      Part {a.partNumber}
                                    </span>
                                  )}
                                </div>
                              ...
                              <span style={{ fontSize: "10px", fontWeight: "700", padding: "3px 10px", borderRadius: "999px", background: passed ? "#E1F5EE" : "#FCEBEB", color: passed ? "#085041" : "#A32D2D", flexShrink: 0 }}>
        ...
        <div>
          ...
          {errors.length > 0 && (
            <div style={{ background: "#FCEBEB", border: "1px solid #F09595", borderRadius: "12px", padding: "16px", marginBottom: "16px" }}>
              <div style={{ fontWeight: "700", color: "#A32D2D", marginBottom: "8px" }}>
            ...
            <div style={{ border: "1.5px solid #eef2ee", borderRadius: "14px", padding: "20px", marginBottom: "16px" }}>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                <button
                  ...
                  disabled={uploading}
                  style={{ padding: "11px 22px", borderRadius: "10px", border: "none", background: uploading ? "#ccc" : "#1D9E75", color: "white", cursor: uploading ? "not-allowed" : "pointer", fontWeight: "700", fontSize: "14px" }}
                >
                  {uploading ? "Uploading..." : `Upload ${parsed.questions.length} questions`}
                </button>
                <button
                  onClick={() => { setParsed(null); setErrors([]); }}
                  style={{ padding: "11px 18px", borderRadius: "10px", border: "1.5px solid #eee", background: "white", cursor: "pointer", fontSize: "14px", color: "#666" }}
                >
                  Cancel
                </button>
              </div>
          ...
          <div style={{ background: "#1a1a2e", borderRadius: "12px", padding: "18px", fontFamily: "monospace", fontSize: "12px", color: "#a8d8a8", lineHeight: "1.8" }}>
            <div style={{ color: "#888", fontFamily: "sans-serif", fontSize: "11px", marginBottom: "10px", fontWeight: "600" }}>
      ...
      {tab === "papers" && (
        <div>
          ...
          {papers.length === 0 ? (
            ...
            <div
              key={p.id}
              style={{ background: "white", border: "1.5px solid #eef2ee", borderRadius: "12px", padding: "16px 20px", marginBottom: "10px", display: "flex", alignItems: "center", gap: "14px", opacity: p.isActive ? 1 : 0.55 }}
            >
              <div style={{ width: "44px", height: "44px", borderRadius: "10px", background: p.paperType === "PAPER_1" ? "#E6F1FB" : "#E1F5EE", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <span style={{ fontSize: "13px", fontWeight: "800", color: p.paperType === "PAPER_1" ? "#0C447C" : "#085041" }}>
                  P{p.paperType === "PAPER_1" ? "1" : "2"}
                </span>
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "3px" }}>
                  ...
                  {!p.isActive && (
                    <span style={{ fontSize: "10px", background: "#FAEEDA", color: "#633806", padding: "1px 8px", borderRadius: "999px", fontWeight: "600" }}>
                      Hidden
                    </span>
                  )}
                </div>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                <button
                  ...
                  style={{ padding: "7px 14px", borderRadius: "8px", border: "1.5px solid #eee", background: "white", cursor: "pointer", fontSize: "12px", fontWeight: "600", color: "#555" }}
                >
                  {p.isActive ? "Hide" : "Show"}
                </button>
                <button
                  onClick={() => deletePaper(p)}
                  style={{ padding: "7px 12px", borderRadius: "8px", border: "1.5px solid #F7C1C1", background: "#FCEBEB", color: "#A32D2D", cursor: "pointer", fontSize: "12px" }}
                >
                  Delete
                </button>
              </div>
